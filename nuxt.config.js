...
module.exports = {
	head: {
		...
		meta: [
			...
			{ name: 'description', content: 'Digipad permet de créer des murs multimédias collaboratifs.' },
			{ property: 'og:title', content: 'Digipad by La Digitale' },
			{ property: 'og:description', content: 'Digipad permet de créer des murs multimédias collaboratifs.' },
